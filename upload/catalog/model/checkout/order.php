...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		$data['delivery_date'] = isset($this->request->post['delivery_date']) ? $this->request->post['delivery_date'] : '';
		$data['delivery_time'] = isset($this->request->post['delivery_time']) ? $this->request->post['delivery_time'] : '';
		$data['pre_call'] = isset($this->request->post['pre_call']) ? $this->request->post['pre_call'] : 0;
